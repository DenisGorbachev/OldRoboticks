...
class sfObjectRouteCollection extends sfRouteCollection
{
  ...
  public function __construct(array $options)
  {
    ...
    $this->options = array_merge(array(
      ...
      'with_show'            => true,
      'segment_names'        => array('edit' => 'edit', 'new' => 'new', 'delete' => 'delete', 'update' => 'update', 'create' => 'create'),
      'model_methods'        => array(),
      'requirements'         => array(),
  ...
  protected function getRouteForList()
  {
    return new $this->routeClass(
      ...
      array_merge($this->options['requirements'], array('sf_method' => array('get', 'post'))),
      array('model' => $this->options['model'], 'type' => 'list', 'method' => $this->options['model_methods']['list'])
    );
  }
  ...
  {
    return new $this->routeClass(
      sprintf('%s/%s.:sf_format', $this->options['prefix_path'], $this->options['segment_names']['create']),
  ...
  {
    return new $this->routeClass(
      sprintf('%s/:%s/%s.:sf_format', $this->options['prefix_path'], $this->options['column'], $this->options['segment_names']['update']),
